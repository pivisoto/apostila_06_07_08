public class CalculadoraSobrecarga {
    ...
    System.out.println(mini.soma(f1, f2));
    //somando dois inteiros
    System.out.println(mini.soma(x, y));
    //somando inteiro e string
    System.out.println(mini.soma(x, s1));
    //somando string e inteiro
    System.out.println(mini.soma(s1, x));
    //somando string e string
    System.out.println(mini.soma(s1, s2));
    //somando três inteiros
    System.out.println(mini.soma(x, y, z));
    }
}
